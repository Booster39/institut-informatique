...
(
  ...
  'Posez des bases solides pour devenir développeur en 1 an et réaliser ton site et ton application : logique, algorithmes simples, pensée structurée, bonnes pratiques, Git/GitHub et organisation de votre apprentissage. À la fin de ce cours, vous saurez lire, comprendre et écrire des programmes simples en suivant une démarche pas à pas.',
  'Build strong foundations to become a developer in 1 year and build your site and your app: logic, simple algorithms, structured thinking, best practices, Git/GitHub and learning organization. By the end of this course, you will be able to read, understand and write simple programs step by step.',
  'ضع أساسًا قويًا لتصبح مطورًا في 1 سنة وتنشئ موقعك وتطبيقك: المنطق، الخوارزميات البسيطة، طريقة التفكير المنظمة، أفضل الممارسات، Git/GitHub وتنظيم مسار تعلّمك. في نهاية هذا الكورس ستكون قادرًا على قراءة وكتابة برامج بسيطة خطوة بخطوة.',
  'BEGINNER', 1, NOW(), NOW()
),
